...
//import java.util.List;
//
//public class AdapterExercise extends RecyclerView.Adapter<AdapterExercise.ListofExercisesViewHolder> {
//    public List<Exercise> exercises;
//    public AdapterExercise(List<Exercise> exercises) {
...
//
//    public static class ListofExercisesViewHolder extends RecyclerView.ViewHolder{
//        public CardView containerview;
//        public TextView textview;
//        public ImageView animationview;
//        ListofExercisesViewHolder(View view) {
//            super(view);
...
//    @NonNull
//    @Override
//    public ListofExercisesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
//
//        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.cardiolowexercise,parent,false);
//        return new ListofExercisesViewHolder(view);
//    }
//
//    @Override
//    public void onBindViewHolder(@NonNull ListofExercisesViewHolder holder, int position) {
