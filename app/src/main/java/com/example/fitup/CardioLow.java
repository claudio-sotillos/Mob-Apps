...
//        numberofexercises.setText(String.valueOf(adapter.getItemCount()));
    ...
    public void initialize(List<Exercise> exercises){
             ...
             RecyclerView recyclerview = findViewById(R.id.cardiolow_recycler_view);
...
//        adapter = new CardioLowAdapter(getApplicationContext());
    ...
    public void passthroughlowexercises(View v){
        ...
        Log.d("HIIIIIIIIIIIIIIIII", String.valueOf(listtoArray));
        Intent inte=new Intent(this,CardioLowPassThrough.class);
        inte.putExtra("position",0);
        inte.putParcelableArrayListExtra("arrayofexercises",listtoArray  );
        startActivity(inte);
        finish();

    }
    public   ArrayList<Exercise> converting(List<Exercise> list) {
